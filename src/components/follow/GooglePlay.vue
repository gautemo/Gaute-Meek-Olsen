<template>
    <a class="play" href="https://play.google.com/store/apps/developer?id=Gaute+Meek+Olsen" target="_blank">
        <svg id="Layer_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 408 466.9" width="50" height="50">
            <linearGradient id="SVGID_1_" gradientUnits="userSpaceOnUse" y1="112.094" x2="261.746" y2="112.094">
                <stop offset="0" stop-color="#63be6b"/><stop offset=".506" stop-color="#5bbc6a"/>
            ...
            </linearGradient><path class="st1" d="M.2 44.4C.5 121.6 1.4 309 1.8 402.3L180 224.1.2 44.4z"/>
            ...
            <linearGradient id="SVGID_4_" gradientUnits="userSpaceOnUse" x1="1.744" y1="345.521" x2="272.296" y2="345.521">
                <stop offset="0" stop-color="#ec3b50"/><stop offset="1" stop-color="#e7515b"/>
            </linearGradient>
