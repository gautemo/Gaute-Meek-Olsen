<template>
    <a class="twitter" href="https://twitter.com/GauteMeekOlsen" target="_blank">
        <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="126.444 2.281 589 589">
            ...
            <path d="M609.773 179.634c-13.891 6.164-28.811 10.331-44.498 12.204 16.01-9.587 28.275-24.779
            ...
            220.428-220.428 0-3.361-.074-6.697-.236-10.021a157.855 157.855 0 0 0 38.707-40.158z" fill="#fff"/>
        </svg>
    </a>
</template>
