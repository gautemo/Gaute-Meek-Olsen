<template>
  <a
    class="medium"
    href="https://medium.com/@gaute.meek"
    target="_blank"
    rel="noopener"
    aria-label="Visit my Medium"
  >
    <svg height="50" width="50" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 195 195">
      <g fill="none">
        <path d="M0 0h195v195H0z" fill="#12100e" class="path"/>
        <path
