<template>
  <article>
    ...
    <section>
      ...
      <span
        class="cmd"
      >vue create [project name]</span>
      Or in an Already Created Project by entering
      <span class="cmd">vue add @vue/pwa</span> into the terminal.
