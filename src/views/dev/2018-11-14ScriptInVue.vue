<template>
  <article>
      ...
      <section>
        ...
        <Gist :id="'344c96c85a4046f22c3c3a711b95ec75'" :file="'vue-script-error.vue'" />
        Building this, Vue throws the error: <i>"Templates should only be responsible for mapping the state to the UI.
        Avoid placing tags with side-effects in your templates, such as script, as they will not be parsed."</i>
      </section>
      <section>
      ...
      <section>
        ...
        Your script won't work and throw this error in the console: <i>"Failed to execute 'write' on 'Document': It isn't possible to write into
        a document from an asynchronously-loaded external script unless it is explicitly opened."</i>
      ...
      <section>
        This can be solved using <a href="https://www.npmjs.com/package/postscribe" target="_blank">postscribe</a>. (see hyperlink for other approaches than NPM install)
        <span class="cmd">npm i postscribe --save</span>
