<template>
  <article>
      ...
      <section>
        ...
        The fields <b>name</b> and <b>version</b> are required. But I encourage you to fill out the other fields as well. This is our package.json file.
        <Gist :id="'344c96c85a4046f22c3c3a711b95ec75'" :file="'package.json'" />
        The <b>main</b> field contains the starting js file (often minified and in a dist folder) where we export our module. Use the <b>bin</b> field if it's a command-line file.
      </section>
      <section>
      ...
      <section>
        If you don't have an NPM user you need to sign up <a href="https://www.npmjs.com/signup" target="_blank">here.</a>
      </section>
      <section>
      ...
      <section>
        That's it, we have published our NPM module. See NPMs <a href="https://docs.npmjs.com/packages-and-modules/contributing-packages-to-the-registry" target="_blank">own guide</a> for a more detailed guide.
      </section>
      <section>
      ...
      <section>
        ...
        Usage:
        <Gist :id="'344c96c85a4046f22c3c3a711b95ec75'" :file="'import-selector.js'" />
        See <a href="https://wesbos.com/javascript-modules/" target="_blank">WesBos guide</a> for how to export and import your modules to fit your need.
      </section>
      <section>
        We also want to access the module from a script tag, we'll use the simple solution <a href="https://unpkg.com" target="_blank">UNPKG</a>
        which gets the file from npmjs for us.
        This is what we put in the src attribute.
        <span class="example">unpkg.com/:package@:version/:file</span>
        ...
        <span class="example">&lt;script src=&quot;https://unpkg.com/selector-library@1.0.6/selector.js&quot;&gt;&lt;/script&gt;</span>
        <span class="example">&lt;script src=&quot;https://unpkg.com/selector-library&quot;&gt;&lt;/script&gt;</span>
      </section>
      <section>
