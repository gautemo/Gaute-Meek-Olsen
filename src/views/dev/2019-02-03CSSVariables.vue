  ...
  <div id="dark-control">
    <article>
        ...
        <section>
          ...
          But you can also change the value of your CSS variables through JavaScript. Which gives us a better way to change the style.
        ...
        <section>
          ...
          <p><i>Remember to click the light bulb.</i></p>
        </section>
...
export default {
  ...
  methods: {
    toggleDark: function () {
      ...
      document.querySelector('article').style.setProperty('--main-color', mainColor)
