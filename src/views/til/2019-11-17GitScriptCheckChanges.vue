<template>
    <article>
        ...
        <span class="code block">$AddedFiles = $(git ls-files --others --exclude-standard $folder | Measure-Object | Select-Object -expand Count)
        ...
        <p>
            <span class="code">git ls-files --others --exclude-standard</span> is for checking untracked files, while
            <span class="code">git diff-index --ignore-cr-at-eol --quiet HEAD</span> is for checking tracked files.
        </p>
    </article>
</template>
