...
var __defNormalProp$9 = (obj, key, value) =>
  key in obj
    ? __defProp$9(obj, key, { enumerable: true, configurable: true, writable: true, value })
    : (obj[key] = value)
...
var __defNormalProp$8 = (obj, key, value) =>
  key in obj
    ? __defProp$8(obj, key, { enumerable: true, configurable: true, writable: true, value })
    : (obj[key] = value)
...
function refWithControl(initial, options = {}) {
  ...
  function set3(value, triggering = true) {
    ...
    const old = source
    if (((_a2 = options.onBeforeChange) == null ? void 0 : _a2.call(options, value, old)) === false) return
    source = value
...
var __defNormalProp$7 = (obj, key, value) =>
  key in obj
    ? __defProp$7(obj, key, { enumerable: true, configurable: true, writable: true, value })
    : (obj[key] = value)
...
function useArrayFind(list, fn) {
  return computed(() =>
    resolveUnref(resolveUnref(list).find((element, index, array) => fn(resolveUnref(element), index, array)))
  )
}
function useArrayFindIndex(list, fn) {
  return computed(() =>
    resolveUnref(list).findIndex((element, index, array) => fn(resolveUnref(element), index, array))
  )
}
...
var __defNormalProp$6 = (obj, key, value) =>
  key in obj
    ? __defProp$6(obj, key, { enumerable: true, configurable: true, writable: true, value })
    : (obj[key] = value)
...
var __objRest$5 = (source, exclude) => {
  ...
  for (var prop in source)
    if (__hasOwnProp$6.call(source, prop) && exclude.indexOf(prop) < 0) target[prop] = source[prop]
...
var __objRest$2 = (source, exclude) => {
  var target = {}
  for (var prop in source)
    if (__hasOwnProp$3.call(source, prop) && exclude.indexOf(prop) < 0) target[prop] = source[prop]
...
var __objRest = (source, exclude) => {
  var target = {}
  for (var prop in source)
    if (__hasOwnProp$1.call(source, prop) && exclude.indexOf(prop) < 0) target[prop] = source[prop]
  ...
  const cleanup = [
    ...
    detectIframe &&
      useEventListener(window2, 'blur', (event) => {
        ...
        const el = unrefElement(target)
        if (
          ((_a2 = window2.document.activeElement) == null ? void 0 : _a2.tagName) === 'IFRAME' &&
...
var __defNormalProp$m = (obj, key, value) =>
  key in obj
    ? __defProp$m(obj, key, { enumerable: true, configurable: true, writable: true, value })
    : (obj[key] = value)
...
function onLongPress(target, handler, options) {
  ...
  function onDown(ev) {
    var _a22, _b2, _c, _d
    if (
      ((_a22 = options == null ? void 0 : options.modifiers) == null ? void 0 : _a22.self) &&
  ...
  const element = customRef((track, trigger) => {
    ...
    return {
      get() {
        var _a2, _b
        track()
        return (_b = (_a2 = instance == null ? void 0 : instance.proxy) == null ? void 0 : _a2.$refs[key]) != null
          ? _b
          : initialValue
      },
      set() {},
...
function useBase64(target, options) {
  ...
  if (isRef(target) || isFunction(target)) watch(target, execute, { immediate: true })
  else execute()
  return {
    base64,
    promise,
...
function useBattery({ navigator = defaultNavigator } = {}) {
  ...
  if (isSupported.value) {
    navigator.getBattery().then((_battery) => {
      ...
      for (const event of events2) useEventListener(battery, event, updateBatteryInfo, { passive: true })
    })
  }
  return {
    isSupported,
...
function useBluetooth(options) {
  ...
  tryOnScopeDispose(() => {
    var _a2
    if (device.value) (_a2 = device.value.gatt) == null ? void 0 : _a2.disconnect()
  })
  return {
    isSupported,
    isConnected,
...
var __defNormalProp$l = (obj, key, value) =>
  key in obj
    ? __defProp$l(obj, key, { enumerable: true, configurable: true, writable: true, value })
    : (obj[key] = value)
...
function useClipboard(options = {}) {
  ...
  function legacyRead() {
    var _a2, _b, _c
    return (_c =
      (_b = (_a2 = document == null ? void 0 : document.getSelection) == null ? void 0 : _a2.call(document)) == null
        ? void 0
        : _b.toString()) != null
      ? _c
      : ''
...
var __defNormalProp$k = (obj, key, value) =>
  key in obj
    ? __defProp$k(obj, key, { enumerable: true, configurable: true, writable: true, value })
    : (obj[key] = value)
...
var __defNormalProp$j = (obj, key, value) =>
  key in obj
    ? __defProp$j(obj, key, { enumerable: true, configurable: true, writable: true, value })
    : (obj[key] = value)
...
var __defNormalProp$i = (obj, key, value) =>
  key in obj
    ? __defProp$i(obj, key, { enumerable: true, configurable: true, writable: true, value })
    : (obj[key] = value)
...
function useColorMode(options = {}) {
  ...
  if (emitAuto) watch(preferredMode, () => onChanged(state.value), { flush: 'post' })
...
function useCssVar(prop, target, { window: window2 = defaultWindow, initialValue = '' } = {}) {
  ...
  const elRef = computed(() => {
    ...
    return (
      unrefElement(target) ||
      ((_a2 = window2 == null ? void 0 : window2.document) == null ? void 0 : _a2.documentElement)
    )
  })
  watch(
  ...
  watch(variable, (val) => {
    var _a2
    if ((_a2 = elRef.value) == null ? void 0 : _a2.style) elRef.value.style.setProperty(resolveUnref(prop), val)
  })
  return variable
}
...
function useCycleList(list, options) {
  ...
  const index = computed({
    get() {
      ...
      if (index2 < 0) index2 = (_a22 = options == null ? void 0 : options.fallbackIndex) != null ? _a22 : 0
      return index2
    },
    set(v) {
      set3(v)
...
var __defNormalProp$h = (obj, key, value) =>
  key in obj
    ? __defProp$h(obj, key, { enumerable: true, configurable: true, writable: true, value })
    : (obj[key] = value)
  ...
  const mode = useColorMode(
    __spreadProps$7(__spreadValues$h({}, options), {
      onChanged: (mode2, defaultHandler) => {
        var _a2
        if (options.onChanged) (_a2 = options.onChanged) == null ? void 0 : _a2.call(options, mode2 === 'dark')
...
var __defNormalProp$g = (obj, key, value) =>
  key in obj
    ? __defProp$g(obj, key, { enumerable: true, configurable: true, writable: true, value })
    : (obj[key] = value)
...
function useRefHistory(source, options = {}) {
  ...
  const manualHistory = useManualRefHistory(
    source,
    __spreadProps$62(__spreadValues$g({}, options), { clone: options.clone || deep, setSource })
  )
...
var __defNormalProp$f = (obj, key, value) =>
  key in obj
    ? __defProp$f(obj, key, { enumerable: true, configurable: true, writable: true, value })
    : (obj[key] = value)
...
var __defNormalProp$e = (obj, key, value) =>
  key in obj
    ? __defProp$e(obj, key, { enumerable: true, configurable: true, writable: true, value })
    : (obj[key] = value)
...
var __objRest$22 = (source, exclude) => {
  var target = {}
  for (var prop in source)
    if (__hasOwnProp$f.call(source, prop) && exclude.indexOf(prop) < 0) target[prop] = source[prop]
...
var __defNormalProp$d = (obj, key, value) =>
  key in obj
    ? __defProp$d(obj, key, { enumerable: true, configurable: true, writable: true, value })
    : (obj[key] = value)
  ...
  const testBounding = () => {
    ...
    if (!el) {
      ...
      elementIsVisible.value =
        rect.top <= (window2.innerHeight || document2.documentElement.clientHeight) &&
        rect.left <= (window2.innerWidth || document2.documentElement.clientWidth) &&
        rect.bottom >= 0 &&
        rect.right >= 0
    }
  }
...
function useFavicon(newIcon = null, options = {}) {
  ...
  const applyIcon = (icon) => {
    document2 == null
      ? void 0
      : document2.head.querySelectorAll(`link[rel*="${rel}"]`).forEach((el) => (el.href = `${baseUrl}${icon}`))
  }
  watch(
    favicon,
    (i, o) => {
...
var __defNormalProp$c = (obj, key, value) =>
  key in obj
    ? __defProp$c(obj, key, { enumerable: true, configurable: true, writable: true, value })
    : (obj[key] = value)
...
function useFetch(url, ...args) {
  ...
  const { fetch = (_a2 = defaultWindow) == null ? void 0 : _a2.fetch, initialData, timeout } = options
  ...
  const execute = async (throwOnFailed = false) => {
    ...
    return new Promise((resolve, reject) => {
      ...
      fetch(
        context.url,
        __spreadProps$32(__spreadValues$c(__spreadValues$c({}, defaultFetchOptions), context.options), {
          headers: __spreadValues$c(
            __spreadValues$c({}, headersToObject(defaultFetchOptions.headers)),
    ...
    return (payload, payloadType) => {
      if (!isFetching.value) {
        ...
        if (isRef(config.payload)) {
          watch([refetch, resolveRef(config.payload)], ([refetch2]) => refetch2 && execute(), { deep: true })
        }
...
var __defNormalProp$b = (obj, key, value) =>
  key in obj
    ? __defProp$b(obj, key, { enumerable: true, configurable: true, writable: true, value })
    : (obj[key] = value)
...
var __defNormalProp$a = (obj, key, value) =>
  key in obj
    ? __defProp$a(obj, key, { enumerable: true, configurable: true, writable: true, value })
    : (obj[key] = value)
var __spreadValues$a = (a, b) => {
  for (var prop in b || (b = {})) if (__hasOwnProp$b2.call(b, prop)) __defNormalProp$a(a, prop, b[prop])
...
function useFileSystemAccess(options = {}) {
  ...
  async function updateData() {
    var _a2, _b
    if (unref(dataType) === 'Text') data.value = await ((_a2 = file.value) == null ? void 0 : _a2.text())
...
function useFocus(target, options = {}) {
  ...
  const focused = computed({
    ...
    set(value) {
      var _a2, _b
      if (!value && focused.value) (_a2 = targetElement.value) == null ? void 0 : _a2.blur()
...
var __defNormalProp$92 = (obj, key, value) =>
  key in obj
    ? __defProp$92(obj, key, { enumerable: true, configurable: true, writable: true, value })
    : (obj[key] = value)
var __spreadValues$92 = (a, b) => {
  for (var prop in b || (b = {})) if (__hasOwnProp$a2.call(b, prop)) __defNormalProp$92(a, prop, b[prop])
...
var __defNormalProp$82 = (obj, key, value) =>
  key in obj
    ? __defProp$82(obj, key, { enumerable: true, configurable: true, writable: true, value })
    : (obj[key] = value)
var __spreadValues$82 = (a, b) => {
  for (var prop in b || (b = {})) if (__hasOwnProp$92.call(b, prop)) __defNormalProp$82(a, prop, b[prop])
...
var __defNormalProp$72 = (obj, key, value) =>
  key in obj
    ? __defProp$72(obj, key, { enumerable: true, configurable: true, writable: true, value })
    : (obj[key] = value)
var __spreadValues$72 = (a, b) => {
  for (var prop in b || (b = {})) if (__hasOwnProp$82.call(b, prop)) __defNormalProp$72(a, prop, b[prop])
...
function useMediaControls(target, options = {}) {
  ...
  useEventListener(target, 'timeupdate', () =>
    ignoreCurrentTimeUpdates(() => (currentTime.value = resolveUnref(target).currentTime))
  )
...
var __objRest$12 = (source, exclude) => {
  var target = {}
  for (var prop in source)
    if (__hasOwnProp$72.call(source, prop) && exclude.indexOf(prop) < 0) target[prop] = source[prop]
  if (source != null && __getOwnPropSymbols$72)
    for (var prop of __getOwnPropSymbols$72(source)) {
      if (exclude.indexOf(prop) < 0 && __propIsEnum$72.call(source, prop)) target[prop] = source[prop]
    }
  return target
}
...
var __defNormalProp$62 = (obj, key, value) =>
  key in obj
    ? __defProp$62(obj, key, { enumerable: true, configurable: true, writable: true, value })
    : (obj[key] = value)
var __spreadValues$62 = (a, b) => {
  for (var prop in b || (b = {})) if (__hasOwnProp$62.call(b, prop)) __defNormalProp$62(a, prop, b[prop])
...
var __defNormalProp$52 = (obj, key, value) =>
  key in obj
    ? __defProp$52(obj, key, { enumerable: true, configurable: true, writable: true, value })
    : (obj[key] = value)
var __spreadValues$52 = (a, b) => {
  for (var prop in b || (b = {})) if (__hasOwnProp$52.call(b, prop)) __defNormalProp$52(a, prop, b[prop])
...
function usePointerSwipe(target, options = {}) {
  ...
  const eventIsAllowed = (e) => {
    ...
    return (_c =
      (_b = (_a2 = options.pointerTypes) == null ? void 0 : _a2.includes(e.pointerType)) != null
        ? _b
...
var __defNormalProp$42 = (obj, key, value) =>
  key in obj
    ? __defProp$42(obj, key, { enumerable: true, configurable: true, writable: true, value })
    : (obj[key] = value)
var __spreadValues$42 = (a, b) => {
  for (var prop in b || (b = {})) if (__hasOwnProp$42.call(b, prop)) __defNormalProp$42(a, prop, b[prop])
...
function useStorageAsync(key, initialValue, storage, options = {}) {
  ...
  read()
  if (window2 && listenToStorageChanges) useEventListener(window2, 'storage', (e) => setTimeout(() => read(e), 0))
  if (storage) {
    watchWithFilter(
      data,
      async () => {
...
function useTextDirection(options = {}) {
  ...
  function getValue2() {
    var _a2, _b
    return (_b =
      (_a2 = document2 == null ? void 0 : document2.querySelector(selector)) == null
        ? void 0
  ...
  return computed({
    ...
    set(v) {
      ...
      dir.value = v
      if (!document2) return
      if (dir.value) (_a2 = document2.querySelector(selector)) == null ? void 0 : _a2.setAttribute('dir', dir.value)
...
var __defNormalProp$32 = (obj, key, value) =>
  key in obj
    ? __defProp$32(obj, key, { enumerable: true, configurable: true, writable: true, value })
    : (obj[key] = value)
var __spreadValues$32 = (a, b) => {
  for (var prop in b || (b = {})) if (__hasOwnProp$32.call(b, prop)) __defNormalProp$32(a, prop, b[prop])
...
var __defNormalProp$22 = (obj, key, value) =>
  key in obj
    ? __defProp$22(obj, key, { enumerable: true, configurable: true, writable: true, value })
    : (obj[key] = value)
var __spreadValues$22 = (a, b) => {
  for (var prop in b || (b = {})) if (__hasOwnProp$22.call(b, prop)) __defNormalProp$22(a, prop, b[prop])
...
var __objRest2 = (source, exclude) => {
  var target = {}
  for (var prop in source)
    if (__hasOwnProp$22.call(source, prop) && exclude.indexOf(prop) < 0) target[prop] = source[prop]
  if (source != null && __getOwnPropSymbols$22)
    for (var prop of __getOwnPropSymbols$22(source)) {
      if (exclude.indexOf(prop) < 0 && __propIsEnum$22.call(source, prop)) target[prop] = source[prop]
    }
  return target
}
var DEFAULT_UNITS = [
...
var __defNormalProp$12 = (obj, key, value) =>
  key in obj
    ? __defProp$12(obj, key, { enumerable: true, configurable: true, writable: true, value })
    : (obj[key] = value)
...
function useTitle(newTitle = null, options = {}) {
  ...
  const title = resolveRef(
    (_a2 = newTitle != null ? newTitle : document2 == null ? void 0 : document2.title) != null ? _a2 : null
  )
